...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5919306669320615001L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"com.br.payment.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\",\"null\"]},{\"name\":\"status\",\"type\":[\"string\",\"null\"]}]}");
  ...
  @Deprecated public java.lang.CharSequence checkoutCode;
   ...
   */
  public CheckoutCreatedEvent(java.lang.CharSequence checkoutCode, java.lang.CharSequence status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: checkoutCode = (java.lang.CharSequence)value$; break;
   ...
   */
  public java.lang.CharSequence getCheckoutCode() {
    return checkoutCode;
  }
   ...
   */
  public void setCheckoutCode(java.lang.CharSequence value) {
   ...
   */
  public static com.br.payment.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new com.br.payment.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.br.payment.event.CheckoutCreatedEvent.Builder newBuilder(com.br.payment.event.CheckoutCreatedEvent.Builder other) {
    return new com.br.payment.event.CheckoutCreatedEvent.Builder(other);
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.br.payment.event.CheckoutCreatedEvent.Builder newBuilder(com.br.payment.event.CheckoutCreatedEvent other) {
    return new com.br.payment.event.CheckoutCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
    ...
    private java.lang.CharSequence checkoutCode;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.br.payment.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.br.payment.event.CheckoutCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.payment.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.payment.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.payment.event.CheckoutCreatedEvent.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.payment.event.CheckoutCreatedEvent.Builder clearStatus() {
      status = null;
    ...
    public CheckoutCreatedEvent build() {
      try {
        ...
        record.checkoutCode = fieldSetFlags()[0] ? this.checkoutCode : (java.lang.CharSequence) defaultValue(fields()[0]);
